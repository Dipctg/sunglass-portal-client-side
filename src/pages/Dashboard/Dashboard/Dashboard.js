...
import AddSunglasses from './AddSunglasses/AddSunglasses';
...
function Dashboard(props) {
  ...
  const drawer = (
    <div>
      ...
      <Link style={{ textDecoration: 'none' }} to={`${url}/addSunglasses`}>
                    <Button color="inherit" >Add Sunglasses</Button>
                    </Link>
        </Box>}
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <AdminRoute path={`${path}/addSunglasses`}>
